...
Our review process follows the **pathfinder mindset**: we prefer approving good contributions over blocking perfect ones.- **Focus on improvement**: The question isn't "Is this perfect?" but rather "Is the codebase better than before?" If the answer is yes, the PR should generally be approved.
