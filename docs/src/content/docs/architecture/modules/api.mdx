...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <a href="#1-grpcserverport-port--grpcadapter"><code>LocalSystemAdapter</code></a>
      </td>
      <td>
        <a href="#1-grpcserverport-port--grpcadapter"><code>GrpcServerPort</code></a>
      </td>
    ...
    <tr>
      <td>
        <a href="#1-grpcserverport-port--grpcadapter"><code>SecureNetworkAdapter</code></a>
      </td>
      <td>
        <a href="#1-grpcserverport-port--grpcadapter"><code>GrpcServerPort</code></a>
      </td>
    ...
    <tr>
      <td>
        <a href="#2-restserverport-port--restadapter"><code>OllamaAdapter</code></a>
      </td>
      <td>
        <a href="#2-restserverport-port--restadapter"><code>RestServerPort</code></a>
      </td>
    ...
    <tr>
      <td>
        <a href="#2-restserverport-port--restadapter"><code>OpenAiAdapter</code></a>
      </td>
      <td>
        <a href="#2-restserverport-port--restadapter"><code>RestServerPort</code></a>
      </td>
